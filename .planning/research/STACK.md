...
**Domain:** Lightweight VS Code extension for copying AI-friendly file references
...
```bash
# Core
npm install --save-dev typescript esbuild @types/vscode @types/node

# Supporting
npm install --save-dev eslint @eslint/js typescript-eslint npm-run-all
...
**If staying true to the MVP (recommended):**
...
**If later adding remote/web support:**
...
Keep business logic pure and testable outside the VS Code API where possible. The activation file should mostly wire commands to small functions.
...
For **File Reference**, use this stack:
...
That is the standard 2025+ stack for a small, maintainable public VS Code extension. It is fast to build, easy to understand, aligned with current Microsoft samples, and avoids premature complexity.
...
---
*Stack research for: VS Code extension for AI-friendly file references*
*Researched: 2026-04-17*
