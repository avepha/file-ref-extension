...
- `ACC-*`, `CLIP-*`, and `REL-*` were still unchecked in the live milestone requirements file at close time, but the roadmap, traceability table, and completed phase summaries all recorded them as shipped. This archive normalizes those items to their final milestone outcome.
- Marketplace and Open VSX publication credentials plus final human smoke/publish steps remain maintainer-operated release tasks, not missing product scope.

## Traceability at Close

| Requirement | Phase | Final Status | Outcome |
|-------------|-------|--------------|---------|
| EDIT-01 | Phase 1 | Complete | Validated in shipped MVP |
| EDIT-02 | Phase 1 | Complete | Validated in shipped MVP |
| REF-01 | Phase 1 | Complete | Validated in shipped MVP |
| REF-02 | Phase 1 | Complete | Validated in shipped MVP |
| REF-03 | Phase 1 | Complete | Validated in shipped MVP |
| REF-04 | Phase 1 | Complete | Validated in shipped MVP |
| REF-05 | Phase 1 | Complete | Validated in shipped MVP |
| ACC-01 | Phase 2 | Complete | Validated in shipped MVP |
| ACC-02 | Phase 2 | Complete | Validated in shipped MVP |
| ACC-03 | Phase 2 | Complete | Validated in shipped MVP |
| CLIP-01 | Phase 2 | Complete | Validated in shipped MVP |
| CLIP-02 | Phase 2 | Complete | Validated in shipped MVP |
| CLIP-03 | Phase 2 | Complete | Validated in shipped MVP |
| REL-01 | Phase 3 | Complete | Validated in shipped MVP |
| REL-02 | Phase 3 | Complete | Validated in shipped MVP |

## Deferred to Future Milestones

- **USE-01**: Context menu entry
- **USE-02**: Multi-root relative-path disambiguation polish
- **FMT-01**: Opinionated alternate output formats
- **SURF-01**: Explorer surface support
